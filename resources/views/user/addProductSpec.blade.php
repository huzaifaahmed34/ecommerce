...
<!-- Content Wrapper. Contains page content -->
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item ">Add Product Specifcations</li>
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header">
              <h1 class="card-title">Add Product Specifications</h1>
            </div>
            <!-- /.card-header -->
 ...
 {{ csrf_field() }}                    <!---Form Start-->
              ...
              <input type="text" class="form-control" id="name" name=name placeholder="Enter Specification Name" value={{@$category}}>
...
$('#form1').on('submit',function (e) {
  e.preventDefault(e);
	...
	var url='<?php echo url('admin/InsertSpecification')?>';
