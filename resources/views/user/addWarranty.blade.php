        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item ">Add Warranty </li>
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header">
              <h1 class="card-title">Add Warranty </h1>
            </div>
            <!-- /.card-header -->
			...
			<div class="col-lg-12  alert-danger">
                ...
                <form id="form1" action="<?php echo url('admin/InsertWarranty')?>"   method="POST" enctype="multipart/form-data">
...
$('#form1').on('submit',function (e) {
  e.preventDefault(e);
	...
	var url='<?php echo url('admin/InsertWarranty')?>';
