          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item ">Orders</li>
               <li class="breadcrumb-item active">View Cancelled Orders</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header">
              <h1 class="card-title">View Cancelled Orders</h1>
            </div>
            <!-- /.card-header -->
...
function show_data(){
    ...
    $.ajax({
      ...
      url:'<?php echo url('admin/CancelOrderShow')?>',
      async:false,
      dataType:'json',
...
var i;
 ...
 html+='<tr>'+
     ...
     '<td>'+res[i].order_date+'</td><td>Rs '+res[i].total_price+'</td>'+'<td>'+res[i].payment_type+'</td>'+
     '<td><a href="javascript:" data='+res[i].oid+'  class="btn btn-danger btn-xs btncancel">'+res[i].status+'</a>&nbsp'+
...
var id=$(this).attr('data');
  ...
  var url='<?php echo url('admin/CancelOrderDetailsShow/')?>/'+id+'';
